...
PROMOTE_HANDLER = DisableAbleCommandHandler("promote", "star", promote, run_async=True)
FULLPROMOTE_HANDLER = DisableAbleCommandHandler("fullpromote", "pstar", fullpromote, run_async=True)
